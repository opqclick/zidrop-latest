...
<div class="profile-edit mrt-30">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <form action="{{url('merchant/profile/edit')}}" method="POST" name="editForm" enctype="multipart/form-data">
                @csrf
                @php
            ...
            <div class="tab-content customt-tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="ownerinformation" role="tabpanel">
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                         ...
                         <div class="form-group row">
                              <div class="col-lg-3 col-md-4 col-sm-4"><p>Image</p></div>
              ...
              <div class="tab-pane fade " id="bankaccount" role="tabpanel">
                  ...
                  <!-- form-group end -->
                  <div class="form-group row">
                      <div class="col-lg-3 col-md-4 col-sm-4"><p>Beneficiary Bank Code</p></div>
                      <div class="col-lg-6 col-md-8 col-sm-8"><input type="text" name="beneficiary_bank_code" value="{{$merchantInfo->beneficiary_bank_code}}" class="form-control"></div>
                  </div>
                  <!-- form-group end -->
                  <div class="form-group row">
