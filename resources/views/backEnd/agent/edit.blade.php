            ...
            <div class="row">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card card-primary">
                    ...
                    <!-- form start -->
                   <form action="{{url('author/agent/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                  @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="bookcommision" id="bookcommision" class="form-control {{ $errors->has('bookcommision') ? ' is-invalid' : '' }}" value="{{$edit_data->bookcommision}}">
