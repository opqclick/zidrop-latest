            ...
            <div class="containerr px-4 pb-4">
                    ...
                    <div class="roww borderr" style="margin-top: -2px;">
                        ...
                        <div class="coll borderr-left">
                            <p class="text-right uppercase bold d-flex p-05 flex-roww borderr-bottom"><span class=" w-50" style="font-size: 9px; font-weight: 700">Merchant Amount</span>
                                @php $marchentAmount = ($show_data->deliveryCharge + $show_data->codCharge - $show_data->cod) * (-1);  @endphp
                                <span class="text-left pl-1 bold color2 w-50">{{ number_format($marchentAmount) }} N</span></p>
                            ...
                            @php $total = (int)$marchentAmount + (int) $show_data->deliveryCharge + (int)$show_data->codCharge @endphp
                            <p class="text-right uppercase bold d-flex p-05 flex-roww"><span class=" w-50" style="font-size: 9px; font-weight: 700">Total Amount</span><span class="text-left pl-1 bold color2 w-50">{{ number_format($total, 2) }} N</span></p>
                        </div>
                    </div>
