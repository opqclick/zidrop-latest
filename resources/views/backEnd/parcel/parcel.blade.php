...
<!--                       <select name="deliverymanId" class="bulkselect" form="myform">
                     ...
                     <button type="submit" name="btn" value="agent" class="bulkbutton bulk-status-btn">Apply</button>
                    ...
                    <table id="example333" class="table table-bordered table-striped custom-table table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><input type="checkbox" class="selectItemCheckbox" value="{{$value->id}}" name="parcel_id[]" form="myform">
                          </form>
                          </td>
